...
export interface BrokerPublicFacetInterface extends utils.Interface {
  functions: {
...
export interface BrokerPublicFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BrokerPublicFacetInterface;
